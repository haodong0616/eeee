...
type ChainConfig struct {
	...
	RpcURL                     string    `gorm:"type:text;not null" json:"rpc_url"`               // RPC地址
	BlockExplorerURL           string    `gorm:"type:text" json:"block_explorer_url"`             // 区块浏览器地址
	...
	PlatformWithdrawPrivateKey string    `gorm:"type:text" json:"platform_withdraw_private_key"`  // 平台提现转账私钥
