      ...
      <div className="bg-[#0f1429] rounded-lg border border-gray-800 overflow-hidden">
        <div className="flex border-b border-gray-800">
          <button
            ...
            className={`flex-1 px-6 py-3 text-sm lg:text-base transition ${
              activeTab === 'deposit'
              ...
              <div className="space-y-3">
                {depositRecords.map((record: any) => {
                  ...
                  return (
                    <div
                      key={record.id}
                      className="bg-[#151a35] rounded-lg p-4 border border-gray-800 hover:border-gray-700 transition"
                    >
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                        ...
                        <div className="flex items-center gap-4">
                          <div>
                            ...
                            <div className="text-xl font-bold">{formatAmount(record.amount, record.asset)} {record.asset}</div>
                            {/* 链信息 */}
                            {chainConfig && (
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
                        ...
                        <div className="flex items-center gap-4">
                          <div>
                            <div className="text-sm text-gray-400 mb-1">提现金额</div>
                            <div className="text-xl font-bold">{formatAmount(record.amount, record.asset)} {record.asset}</div>
                            {/* 链信息 */}
                            {chainConfig && (
                              <div className="text-xs text-gray-500 mt-1">
                        ...
                        {/* 右侧：状态 */}
                        <div>
                          <span className={`px-3 py-1.5 rounded text-sm whitespace-nowrap ${
